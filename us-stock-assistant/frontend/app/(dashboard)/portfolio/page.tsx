    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
        ...
        <div className="flex flex-wrap gap-2 w-full sm:w-auto">
          {/* Import Button */}
          <button onClick={() => setShowImportModal(true)} className="flex-1 max-w-[calc(50%-0.25rem)] sm:flex-none sm:max-w-none px-3 sm:px-6 py-2.5 sm:py-3 bg-purple-600 text-white rounded-lg hover:bg-purple-700 font-medium flex items-center justify-center gap-1 sm:gap-2 text-sm sm:text-base">
          ...
          <div className="relative export-menu-container flex-1 max-w-[calc(50%-0.25rem)] sm:flex-none sm:max-w-none">
            <button onClick={() => setShowExportMenu(!showExportMenu)} disabled={isExporting || !portfolio?.positions || portfolio.positions.length === 0} className="w-full px-3 sm:px-6 py-2.5 sm:py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 font-medium disabled:bg-gray-300 disabled:cursor-not-allowed flex items-center justify-center gap-1 sm:gap-2 text-sm sm:text-base">
              {isExporting ? (
                <>
          ...
          <button onClick={() => setShowAddModal(true)} className="w-full sm:w-auto px-3 sm:px-6 py-2.5 sm:py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-medium text-sm sm:text-base">
            + Add Stock
          </button>
        </div>
      </div>
