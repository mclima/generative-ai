...
# Vercel build script for VisionAssist
# Downloads pre-converted YOLOv8n model files

set -e

echo "📦 Downloading YOLOv8n model for Vercel deployment..."
...
echo "Downloading model weights (4 shards)..."
