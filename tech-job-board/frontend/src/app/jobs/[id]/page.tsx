...
// Format job description to add paragraph breaks
const formatJobDescription = (description: string): string => {
  // If description already has HTML tags, return as is
  if (description.includes('<p>') || description.includes('<br>')) {
    return description
  }
  
  // Split on common section headers and add paragraph breaks
