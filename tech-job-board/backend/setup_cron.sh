#!/bin/bash
# Setup script for configuring the weekly job refresh cron job
# This script helps set up a cron job to run at 3pm EST on Wednesdays
...
echo "================================"
echo ""
echo "This will set up a weekly cron job to refresh jobs on Wednesdays at 3pm EST."
echo ""
...
# 0 20 * * 3 means: minute=0, hour=20 (UTC), every Wednesday (day 3)
# 8pm UTC = 3pm EST (UTC-5)
CRON_CMD="0 20 * * 3 cd $SCRIPT_DIR && $PYTHON_PATH app/cron_job.py >> $SCRIPT_DIR/cron_job.log 2>&1"
